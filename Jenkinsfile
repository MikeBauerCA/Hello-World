    ...
    stages {
        stage('build') {
            ...
            steps {
                ...
                sh 'bright --version'
                sh 'npm install'
                withCredentials([usernamePassword(credentialsId: 'brightProfCreds19', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD'), string(credentialsId: 'host', variable: 'HOST'), string(credentialsId: 'port', variable: 'PORT')]) {
